...
\t\t\t  -DRAT proof generated by solver has to be in a file named \"proof.out\" or which named is given with -drat-file option
\t\t\t  NB: if SOLVER is the empty string then DRATTRIM is attempted on DRAT_FILE\n");
